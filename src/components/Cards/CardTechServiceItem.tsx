...
const CardTechServiceItem = (props: CardTechServiceItem) => {
  ...
  return (
    <div className="w-full h-full bg-gray-light group">
      <div className="relative w-full aspect-[16/12] bg-gray-100 flex items-center justify-center">
        {image && (
          <Image
            ...
            priority={true}
            sizes="auto"
            className="block w-full h-full absolute object-center object-cover top-0 left-0 z-0 transition-all"
          />
        )}
        {ornament && (
      ...
      <div className="px-12 md:px-18 py-16 md:py-32 bg-gray-light flex items-center justify-between self-center min-h-[112px]">
        <HeadingText className="uppercase text-black text-12 md:text-16 leading-[1.313rem] md:leading-[1.5rem] tracking-[-0.02em] transition-all duration-300 group-hover:text-blue-pacific">
          {title}
        </HeadingText>
        ...
        >
          <path
            ...
            className="transition-all duration-300 fill-black group-hover:fill-blue-pacific"
          />
        </svg>
      </div>
    </div>
