...
const BannerTech = (props: TBannerTechProps) => {
  ...
  return (
    <section className="relative h-[400px] md:h-[520px] lg:h-[653px] px-16">
      {background && (
        <Image
          src={background}
          alt="Banner Image"
      ...
      <div className="w-full max-w-[1128px] h-full mx-auto relative z-[2] flex justify-center items-start flex-col">
        {children}
      </div>
    </section>
  );
