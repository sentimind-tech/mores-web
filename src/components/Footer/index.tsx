...
const Footer = () => {
  return (
    <div className="bg-white font-supplymono px-16 lg:px-[3.938rem] pt-[4.5rem] pb-[3.125rem]">
          ...
          <div className="flex gap-[3.75rem]">
            ...
            <div className="block">
              ...
              <div className="max-w-[212px] mb-[2.875rem]">
                <HeadingText className="leading-[1.2rem] text-blue-pacific uppercase block mb-[0.313rem]">
                  OFFICE
                </HeadingText>
