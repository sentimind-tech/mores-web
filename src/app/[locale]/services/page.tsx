          ...
          <section className="">
            <SectionInfo title="Services">
              <p className="section-info-p">
                Mores Strategics multi-approach strategy development consists of
                3 main stages: Data, Strategy, and Operation. Our framework is
                malleable and tailored to suit our clientsʼ needs and capacity
              </p>
            </SectionInfo>
          </section>
